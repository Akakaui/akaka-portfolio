export default function Sidebar({ currentPage, navigate, theme, toggleTheme }) {
  const navItems = [
    ...
    { id: 'playground', label: 'Playground', icon: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><polygon points="13 2 3 14 12 14 11 22 21 10 12 10"/></svg> },
  ...
  return (
    <aside className="sidebar">
      ...
      <div className="sidebar-bottom">
        <button className="connect-link" onClick={() => navigate('contact')}>
        ...
        <div className="theme-toggle">
          <button className={theme === 'light' ? 'active' : ''} onClick={toggleTheme} aria-label="Light mode">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><circle cx="12" cy="12" r="5"/><line x1="12" y1="1" x2="12" y2="3"/><line x1="12" y1="21" x2="12" y2="23"/><line x1="4.22" y1="4.22" x2="5.64" y2="5.64"/><line x1="18.36" y1="18.36" x2="19.78" y2="19.78"/><line x1="1" y1="12" x2="3" y2="12"/><line x1="21" y1="12" x2="23" y2="12"/><line x1="4.22" y1="19.78" x2="5.64" y2="18.36"/><line x1="18.36" y1="5.64" x2="19.78" y2="4.22"/></svg>
          </button>
          <button className={theme === 'dark' ? 'active' : ''} onClick={toggleTheme} aria-label="Dark mode">
